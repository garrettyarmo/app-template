 ...
 *   - /my-picks (User Picks) for tracking personal bets
 *   - /leaderboard for seeing the community's performance
 *
 * Key Features:
 ...
 * - A new block of content linking to picks, leaderboard, and user picks
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div className="rounded-md border p-4 shadow-sm">
              ...
              <p className="text-muted-foreground mb-4 text-sm">
                See today's NBA spread picks generated by our LLM-based model.
            ...
            {/* Card for User Picks */}
            <div className="rounded-md border p-4 shadow-sm">
              <h3 className="mb-2 text-xl font-semibold">My Picks</h3>
              <p className="text-muted-foreground mb-4 text-sm">
                Track your own NBA wagers, record your choices, and see how you
                fare each day.
              </p>
              <a
                href="/my-picks"
                className="bg-secondary text-secondary-foreground hover:bg-secondary/80 inline-block rounded px-4 py-2 text-sm font-medium"
              >
                Go to My Picks
              </a>
            </div>
            ...
            <div className="rounded-md border p-4 shadow-sm">
              ...
              <p className="text-muted-foreground mb-4 text-sm">
                Compare performance across the community, and see who’s on top
                of the scoreboard.
              </p>
              <a
                href="/leaderboard"
                className="bg-accent text-accent-foreground hover:bg-accent/80 inline-block rounded px-4 py-2 text-sm font-medium"
              >
                See Leaderboard
              </a>
            </div>
        ...
        <section className="mx-auto mt-10 max-w-5xl px-4 text-center">
          ...
          {userId ? (
            <div className="mb-2 text-sm">
              ...
              <a href="/my-picks" className="text-blue-500 hover:underline">
                track your picks
              </a>{" "}
              if you haven’t yet.
            </div>
            ...
            <div className="mb-2 text-sm">
              <p className="mb-4">
                Create a free account to start tracking your picks. Upgrade to
                Pro for full access to AI picks!
              </p>
